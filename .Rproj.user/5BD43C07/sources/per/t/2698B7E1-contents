...
rm(syphilis, gonorrhea, chlamydia ) #Closing the old tables
colnames (allDisease) = c("Disease","State", "State_Code", "Year", "Gender","Gender_Code", "Age", "Age_Code", "STD_Cases", "Population")
colnames (allDiseaseEthnia) = c("Disease","State", "Gender", "Race/Ethnicity", "Age","Age_Code", "STD_Cases", "Population")
#Janitoring the data
